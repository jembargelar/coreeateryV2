    ...
    <section className="relative bg-charcoal py-16 md:py-20 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-5 md:px-8 text-center">
        ...
        <p className="font-body text-stone text-sm md:text-base mt-4 max-w-xl mx-auto leading-relaxed">
          Info diskon, menu musiman, dan event spesial kami umumkan lebih
          dulu di Instagram. Follow{' '}
          <span className="text-gilt-soft">{siteConfig.social.instagramHandle}</span>{' '}
          biar ga ketinggalan.
        </p>
        <a
